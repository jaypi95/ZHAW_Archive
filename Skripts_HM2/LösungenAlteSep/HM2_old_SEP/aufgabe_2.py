...
"""
a, b = sy.symbols('a,b')
a, b = 2,4 # irgendwie ist die lösung von a) mit den Zahlen von b) berechnet worden
...
def is_finished(f, x):
    ...
    return is_finished_max_residual(f, x, 1e-8)    # Abbruchkriterium d): Abbruch, wenn ‖f(x(n+1))‖₂ ≤ 𝛜
...
# b )
# nach 6 iterationen: x6 = [0.9439, -0.33018]